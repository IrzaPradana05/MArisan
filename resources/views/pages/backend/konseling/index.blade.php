...
@endpush
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Bimbingan Konseling</h1>
			<!-- end page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Data Bimbingan Konseling</h4>
						</div>
						<!-- end panel-heading -->
								...
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="{{route('konseling-create')}}" method="post">
												@csrf
												@method('post')
												<div class="row">
													<div class="col-md-12">
														...
														<label for="catatan">Catatan Konseling <small class="text-danger">*</small></label>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form name="update" action="" method="post">
												...
												<div class="row">
													<div class="col-md-12">
														<label for="catatan_edit">Catatan Konseling <small class="text-danger">*</small></label>
								...
								<tbody>
									...
									@foreach($konseling as $data)
										<tr>
											...
											@roleCanAccess(['0'])
												<td>
													<a href="javascript:;" url="{{route('konseling-ajax-edit', $data->id)}}" class="edit_data" url-update="{{route('konseling-update', $data->id)}}"><i class="fas fa-lg fa-fw m-r-10 fa-edit text-warning"></i></a>
													<a href="{{route('konseling-delete', $data->id)}}"><i class="fas fa-lg fa-fw m-r-10 fa-trash text-danger"></i></a>
												</td>
											@endroleCanAccess
										</tr>
									@endforeach
