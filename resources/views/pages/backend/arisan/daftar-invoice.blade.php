				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Data Invoice</h4>
						</div>
						<!-- end panel-heading -->
								...
								<tbody>
									...
									@foreach($iuran as $data)
										<tr>
											...
											<td>
												<a href="javascript:;" url="{{route('cek-invoice', $data->id)}}" class="edit_data" url-update="{{route('update-status-pembayaran', $data->id)}}"><i class="fas fa-lg fa-fw m-r-10 fa-edit text-warning"></i></a>
											</td>
										</tr>
									@endforeach
								</tbody>
