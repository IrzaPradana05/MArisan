				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Kontak Pesan</h4>
						</div>
						<!-- end panel-heading -->
						...
						<div class="panel-body">
							<table id="data-table-kamar" class="table table-striped table-bordered">
								<thead>
									<tr>
										<th width="1%">No</th>
										<th class="text-nowrap">Nama Kontak</th>
								...
								<tbody>
									...
									@foreach($kontak as $data)
										<tr>
											<td>{{$num++}}</td>
											<td><a href="{{route('chat-panel',$data->id)}}">{{ucwords($data->name)}} </a><span class="badge badge-pink" {{$data->pesan_baru ? '' : 'hidden'}}>{{$data->pesan_baru ? 'Pesan Baru' : ''}}</span></td>
											<td>{{$data->role == '0' ? 'Admin' : ($data->role == '1' ? 'Siswa' : '')}}</td>
										</tr>
									@endforeach
								</tbody>
							</table>
