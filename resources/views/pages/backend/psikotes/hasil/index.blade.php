...
@endpush
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<h5 class=""><b>{{ucwords($pengumuman->teks_pengumuman)}}</b></h5>
			<!-- end page-header -->
								...
								<tbody>
									...
									@foreach($hasil as $data)
										<tr>
											...
											@roleCanAccess(['0'])
												<td>
													<a href="javascript:;" url="{{route('psikotes-ajax-edit', ['id' => $data->id])}}" class="edit_data" url-update="{{route('psikotes-update', ['id' => $data->id, 'id_pengumuman' => $pengumuman->id])}}"><i class="fas fa-lg fa-fw m-r-10 fa-edit text-warning"></i></a>
													<a href="{{route('psikotes-delete', ['id' => $data->id, 'id_pengumuman' => $pengumuman->id])}}"><i class="fas fa-lg fa-fw m-r-10 fa-trash text-danger"></i></a>
												</td>
											@endroleCanAccess
										</tr>
									@endforeach
