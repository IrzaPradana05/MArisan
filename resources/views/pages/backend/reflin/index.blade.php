	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item">Reflin</li>
				<li class="breadcrumb-item active">Hasil Tes</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Data Tes Reflin</h1>
			<!-- end page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Data Hasil Tes</h4>
						</div>
						<!-- end panel-heading -->

						<div class="panel-body">
							@roleCanAccess(['0'])
								<a href="#add_data" class="btn btn-primary btn-lg" data-toggle="modal">Input Hasil Tes</a>
							@endroleCanAccess
								...
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										<div class="modal-header">
											<h4 class="modal-title">Hasil Tes Siswa</h4>
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
										</div>
										<div class="modal-body">
											<form action="{{route('reflin-create')}}" method="post">
												@csrf
												@method('post')
												<div class="row">
													<div class="col-md-12">
								...
								<tbody>
									...
									@foreach($hasil as $data)
										<tr>
											...
											@roleCanAccess(['0'])
												<td>
													<a href="javascript:;" url="{{route('reflin-ajax-edit', ['id' => $data->id])}}" class="edit_data" url-update="{{route('reflin-update', ['id' => $data->id])}}"><i class="fas fa-lg fa-fw m-r-10 fa-edit text-warning"></i></a>
													<a href="{{route('reflin-delete', ['id' => $data->id])}}"><i class="fas fa-lg fa-fw m-r-10 fa-trash text-danger"></i></a>
												</td>
											@endroleCanAccess
										</tr>
									@endforeach
